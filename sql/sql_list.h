...
*/
/**
 * the meaning of "intrusive" I can not understand.
 * maybe because the SQL_I_List operate a list not a node.
 */
/*
 * like base_list the type T in this is list_node in base_list 
 * so I guess maybe the type T is almost like the list_node 
 *   the next ptr is the first element of struct T
 *
 */
template <typename T>
